...
export default function LiveDealPanel({
  ...
  return (
    <div className="rounded-3xl border border-slate-200 p-4">
      ...
      <select disabled={Boolean(currentDeal)} value={dealProductId} onChange={(e) => setDealProductId(e.target.value)} className="mt-3 w-full rounded-2xl border border-slate-200 px-3 py-2 text-sm disabled:bg-slate-100">
