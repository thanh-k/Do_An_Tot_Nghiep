  ...
  return (
    <div className="container-padded py-8">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        {/* Cột phụ: Thông tin đơn hàng & Giao hàng */}
          ...
          <div className="card p-6">
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="mt-4 rounded-xl bg-slate-50 p-4">
                ...
                <span
                  className={`inline-block rounded-full px-4 py-1.5 text-xs font-black uppercase tracking-wider mt-1 ${getStatusColorClass(order.status)}`}
                >
